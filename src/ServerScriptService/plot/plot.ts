...
class Plot {
	...
	*/
	...
	loadGridBaseparts() {
		for (const tileRow of this.tileGrid.getTiles()) {
			for (const tile of tileRow) {
				...
				basepart.Position = tile.getGlobalPosition(this.gridBase);
				basepart.Parent = this.gridBase.FindFirstChild("PlacedObjects");
