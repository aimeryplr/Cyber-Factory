...
import { findBasepartByName, getLocalPosition, removeConectedTiles } from "ReplicatedStorage/Scripts/Tile Entities/Utils/tileEntityUtils";
...
import { getTileEntityByCategory, getTileEntityInformation } from "ReplicatedStorage/Scripts/Tile Entities/tileEntityProvider";
